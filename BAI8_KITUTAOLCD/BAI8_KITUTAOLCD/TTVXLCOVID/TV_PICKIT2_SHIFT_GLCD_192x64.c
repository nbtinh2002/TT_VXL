...
void glcd_update_last_area(unsigned int8 x1, unsigned int8 y1, unsigned int8 x2, unsigned int8 y2)
{
   area_codinate.x1 = x1;
   area_codinate.x2 = x2;
   area_codinate.y1 = y1;
...
void glcd_graphic_text_setup(unsigned int16 x, unsigned int16 y,int8 size, int8 mau)
{
      glcd_grt.mau = mau;
      glcd_grt.size = size;
      glcd_grt.x    = x;
...
void glcd_triangle_fill(signed int16 x1,signed int16 y1, signed int16 x2, signed int16 y2, signed int16 x3, signed int16 y3,int1 color)
{
